...
const baseUrl: string = process.env.BACKEND_URL || "http://192.168.8.160:5000";
...
// Test hash 
router.get("/test-hash", (req: Request, res: Response) => {
...
router.get("/test-happypaws-hash", (req: Request, res: Response) => {
...
router.get("/total/:orgId", async (req: Request, res: Response) => {
  try {
