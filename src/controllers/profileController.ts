...
const createGeneralProfile = async (req: Request, res: Response): Promise<void> => {
  try {
...
const createVolunteerProfile = async (req: Request, res: Response): Promise<void> => {
  try {
    const { location, bio, profileImage, name } = req.body;
    const userId = req.user!.id;
...
const createNGOProfile = async (req: Request, res: Response): Promise<void> => {
  try {
...
const updateGeneralProfile = async (req: Request, res: Response): Promise<void> => {
  try {
    const userId = req.user!.id;
...
const updateVolunteerProfile = async (req: Request, res: Response): Promise<void> => {
  try {
    const userId = req.user!.id;
    const { location, bio, profileImage } = req.body;
...
const updateNGOProfile = async (req: Request, res: Response): Promise<void> => {
  try {
    const userId = req.user!.id;
    const { orgName, contactPerson, regNumber, foundedYear, location, bio, profileImage, verificationDocument, merchantId, merchantSecret } = req.body;
