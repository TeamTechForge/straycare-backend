...
const authValidator_1 = require("../../../src/validators/authValidator");
describe('AuthValidator', () => {
    describe('validateRegistrationPayload', () => {
        it('should return isValid true for a completely valid payload', () => {
            ...
            const result = authValidator_1.AuthValidator.validateRegistrationPayload(validPayload);
        ...
        it('should return isValid false if name is missing', () => {
            ...
            const result = authValidator_1.AuthValidator.validateRegistrationPayload(invalidPayload);
...
//# sourceMappingURL=authValidator.unit.test.js.map