...
describe('Chat Controller Unit Tests', () => {
    ...
    describe('getOrCreateConversation', () => {
        ...
        it('should return existing conversation and evaluate permissions (Duplicate check)', async () => {
            ...
            privacyService_1.default.canMessage.mockResolvedValue(mockPrivacy);
    ...
    describe('sendMessage', () => {
        it('should enforce privacy restrictions when sending a message', async () => {
            ...
            privacyService_1.default.canMessage.mockResolvedValue({ allowed: false, reason: 'Blocked' });
        ...
        it('should save message and emit socket events', async () => {
            ...
            privacyService_1.default.canMessage.mockResolvedValue({ allowed: true });
    ...
    describe('markAsRead', () => {
        it('should update messages and reset unread counts (Read Receipts)', async () => {
            ...
            expect(Message.updateMany).toHaveBeenCalledWith({ conversationId: 'conv1', readBy: { $ne: 'user1' } }, { $addToSet: { readBy: 'user1' } });
...
//# sourceMappingURL=chatController.unit.test.js.map