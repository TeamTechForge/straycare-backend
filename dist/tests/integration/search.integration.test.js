...
describe('Search Integration Tests', () => {
    ...
    beforeEach(async () => {
        ...
        const ngoUser = await User_1.default.create({ name: 'Animal Rescue Squad', email: 'ngo@test.com', password: 'pwd', role: 'ngo', phone: '+94770000001' });
        ...
        const vetUser = await User_1.default.create({ name: 'Smith', email: 'vet@test.com', password: 'pwd', role: 'vet', phone: '+94770000002' });
    ...
    it('should return 401 Unauthorized if no token is provided', async () => {
        const response = await (0, supertest_1.default)(app).get('/api/search?q=dogs');
