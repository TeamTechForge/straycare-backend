...
if (!mongoURI) {
    console.error("[GridFS] MONGO_URI is undefined. File uploads require a valid MongoDB URL.");
}
const upload = multer({
...
const uploadSingleFileToGridFs = (bucket, file) => new Promise((resolve, reject) => {
