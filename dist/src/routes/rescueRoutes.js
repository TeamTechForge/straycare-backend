...
const { findNearestRescuer, sendRescueRequest, checkRequestStatus, listRescuers, getActiveRescuerRequest, respondToRescueRequest, updateRescueDetails, } = require("../controllers/rescueController");
