...
const createGeneralProfile = (0, catchAsync_1.catchAsync)(async (req, res, next) => {
...
const createVolunteerProfile = (0, catchAsync_1.catchAsync)(async (req, res, next) => {
    const { location, bio, profileImage, name } = req.body;
    const userId = req.user.id;
...
const createNGOProfile = (0, catchAsync_1.catchAsync)(async (req, res, next) => {
...
const createVetProfile = (0, catchAsync_1.catchAsync)(async (req, res, next) => {
