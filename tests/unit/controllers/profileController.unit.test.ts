...
describe('Profile Controller', () => {
  ...
  describe('createGeneralProfile', () => {
    it('should create a general profile and update user successfully', async () => {
      ...
      expect(GeneralUserProfile.findOneAndUpdate).toHaveBeenCalledWith(
        { userId: 'user123' },
        { location: 'Colombo', bio: 'Hello', profileImage: 'img.png' },
      ...
      expect(res.json).toHaveBeenCalledWith(
        expect.objectContaining({ message: 'General profile created' })
      );
    });
  });
  ...
  describe('createVolunteerProfile', () => {
    it('should create a volunteer profile and update both User and Rescuer', async () => {
      ...
      expect(Rescuer.findOneAndUpdate).toHaveBeenCalledWith(
        { userId: 'user123' },
        {
          userId: 'user123',
          name: 'Jane',
